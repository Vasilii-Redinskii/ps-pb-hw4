...
log = [{'user': user_list[0], 'purchases': [item_list[0], item_list[2], item_list[2], item_list[2]]},
...
for record in log:
    ...
    for item in record['purchases']:
        ...
        for popular_item in popular_items:
            ...
            # оставшиеся значения перечисляем без проверки.
           if popular_item['title'] == purchase_title and found == False:
